...
class _DashboardState extends State<Dashboard> {
  ...
  var question = {
    ...
    'personal_answer': "Mine is definitely the peace in the morning.",
  };
  var options = [
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      ...
                                      color:
                                          Color.fromRGBO(203, 201, 255, 0.7)),
                                ),
                              ),
                              Container(
                                height: Platform.isAndroid ? 170 : 148,
                                ...
                                child: GridView.builder(
                                  ...
                                  gridDelegate:
                                    ...
                                    crossAxisSpacing: 10,
                                    mainAxisSpacing: 10,
                                    childAspectRatio: 4 / 1.47,
                                  ),
                                  itemCount: options.length,
                                  itemBuilder: (context, index) {
                                    return buildOption(options[index]['title']!,
                                        options[index]['value']!);
                                  },
                                ),
                              ),
